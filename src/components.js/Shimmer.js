    ...
    return(
     <div>
        <div className=" bg-gray-600 w-full h-[350px]  flex flex-col items-center justify-center">
            <h1 className="font-bold text-center text-white text-2xl pt-20 ">Looking for great food near you</h1>
        ...
        <div key={index} className="bg-slate-200 w-[250px] h-[180px] rounded-lg p-2 mt-4 ml-4  z-10">
